...
El proyecto consisten en poder ingresar comandos y  códigos fuentes,  los cuales ayuden al aprendizaje y retención de información, he notado que cuando se esta iniciando en desarrollo tener códigos de referencia ayuda bastante, buscar códigos en internet es sencillo lo complejo es cuando encuentras uno que satisface tu necesidad lo modificas para adaptarlo mejor y queda en unos de los proyectos que realízate, y tiempo despues quieres desarrollar algún producto que implemente ese código, lo que implica tener que  buscar la pagina donde los tomaste o buscar en  el proyecto donde lo implementaste, la idea de este software es ayudar en esa gestión, almacenar y gestionar ese código fuente que tanto te demóraste en desarrollar que satisface una necesidad especifica, ademas almacenar un listado de comandos.


[https://librarycheatcodes.herokuapp.com](https://librarycheatcodes.herokuapp.com)

Puede observar los comandos y codigos que compartan los usuarios del portal sin registrate, la información que quiera que permanesca privada tienes que registrarte.
...
Se han aplicados los conceptos aprendidos en Platzi en los cursos de Frontend y Backend
